...
Drupal.behaviors.horizontalTabs = {
  attach: function (context) {
    $('.horizontal-tabs-panes', context).once('horizontal-tabs', function () {
      ...
      $(this).wrap('<div class="tabbable clearfix"></div>').before(tab_list);

      // Transform each fieldset into a tab.
      $fieldsets.each(function (i) {
        var horizontal_tab = new Drupal.BTAhorizontalTab({
      ...
      $('.horizontal-tabs-pane:first').addClass('active');
    });
  }
};
 ...
 */
Drupal.BTAhorizontalTab = function (settings) {
  var self = this;
...
Drupal.BTAhorizontalTab.prototype = {
  /**
    ...
    this.fieldset
      ...
      .siblings('fieldset.horizontal-tabs-pane')
        .each(function () {
          ...
          tab.fieldset.removeClass('active');
